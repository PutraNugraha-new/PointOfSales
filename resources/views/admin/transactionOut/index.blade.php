...
@section('container')
    ...
    <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white border-b-2 border-indigo-600">
        <div class="flex gap-1 mb-10">
            <a href="{{ route('transactionOut.create') }}"
        ...
        <table id="dataItem" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
            <thead>
                <tr>
                    ...
                    <th data-priority="4">Tanggal Keluar</th>
                    <th>Action</th>
                </tr>
            </thead>
            <tbody>
                @forelse ($transactionOut as $data)
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <a href="{{ route('transactionOut.edit', $data->id) }}"
                                ...
                                <form action="{{ route('transactionOut.destroy', $data->id) }}" method="POST"
    ...
    @include('admin.transactionOut.feature.modal')
@endsection
@section('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            viewButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    fetch(`/transactionOut/${itemId}/detail`)
