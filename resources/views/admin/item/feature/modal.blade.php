        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form action="/importItems" method="POST" class="max-w-lg mx-auto" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                ...
                                <p id="modal-category" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                <label class="block text-sm font-medium text-gray-600">Kode SKU</label>
                                <p id="modal-sku" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                ...
                                <p id="modal-stock" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                <label class="block text-sm font-medium text-gray-600">Unit</label>
                                <p id="modal-unit" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                <label class="block text-sm font-medium text-gray-600">Harga</label>
                                <p id="modal-price" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4 col-span-2">
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                ...
                                <p id="modal-description" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                        </div>
                    </div>
                </div>
