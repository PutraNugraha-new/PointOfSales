        ...
        <table id="dataItem" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
            <thead>
                <tr>
                    ...
                    <th data-priority="3">Kode SKU</th>
                    <th data-priority="4">Stok</th>
                    <th data-priority="5">Unit</th>
                    <th data-priority="6">Harga Beli</th>
                    <th data-priority="7">Harga Jual</th>
                    <th data-priority="8">Tanggal Ditambahkan</th>
                    <th>Action</th>
                </tr>
            </thead>
            <tbody>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            viewButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    fetch(`/items/${itemId}/detail`)
                        .then(response => response.json())
                        .then(data => {
                            // Update konten modal
                            document.getElementById('modal-name').textContent = data.name;
                            document.getElementById('judul-modal').textContent = data.name;
                            document.getElementById('modal-category').textContent = data
                                .category.name;
                            ...
                            document.getElementById('modal-description').textContent = data
                                .description;
                            document.getElementById('modal-price').textContent = new Intl
                                .NumberFormat('id-ID', {
                                    style: 'currency',
                                    currency: 'IDR'
