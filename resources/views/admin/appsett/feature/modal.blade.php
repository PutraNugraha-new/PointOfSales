                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                ...
                                <p id="modal-supplier" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                <label class="block text-sm font-medium text-gray-600">Kuantitas</label>
                                <p id="modal-quantity" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                <label class="block text-sm font-medium text-gray-600">Tanggal Masuk</label>
                                <p id="modal-date" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4 col-span-2">
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                                ...
                                <p id="modal-note" class="mt-1 text-sm font-semibold text-gray-800"></p>
                            </div>
                        </div>
                    </div>
                </div>
